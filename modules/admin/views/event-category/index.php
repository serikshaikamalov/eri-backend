...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="list-group">
            <a href="/admin/event" class="list-group-item list-group-item-action">Event List</a>
            <a href="/admin/event-category" class="list-group-item list-group-item-action active">Event Category</a>
        </div>
    </div>
